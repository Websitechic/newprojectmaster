...
export default function DeadlineExtensionRequestsPage() {
  ...
  // Check if user has proper access (project managers, operations managers, and replit developers)
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-auto p-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-2">This page is only available to project managers, operations managers, and Replit developers.</p>
