...
export default function LeaveApplication() {
  ...
  // Check if user is staff, intern, product owner, or customer support officer
  if (!user || (user.role !== "staff" && user.role !== "intern" && user.role !== "product_owner" && user.role !== "customer_support_officer")) {
    return (
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex flex-col items-center justify-center min-h-[400px]">
            ...
            <p className="text-sm text-destructive">Only staff members, interns, product owners, and customer support officers can access leave applications</p>
          </div>
        </div>
      </div>
    );
