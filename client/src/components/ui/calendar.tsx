  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-6 font-normal text-[9px]",
        ...
        day: cn(
          ...
          "h-6 w-6 p-0 font-normal text-[10px] aria-selected:opacity-100"
        ),
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-2.5 w-2.5" />,
        IconRight: ({ ...props }) => <ChevronRight className="h-2.5 w-2.5" />,
      }}
      {...props}
    />
  )
