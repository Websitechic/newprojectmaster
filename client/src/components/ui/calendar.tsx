...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-2 w-fit mx-auto", className)}
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md w-8 font-normal text-[0.8rem] flex justify-center",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 flex justify-center items-center"
        ),
